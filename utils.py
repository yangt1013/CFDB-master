...
def test(net, criterion, batch_size):
    ...
    for batch_idx, (inputs, targets) in enumerate(testloader):
        ...
        output1, output2,output_image1,output_image2,output_concat= net(inputs)
        # outputs_com = output1 + output2 + output_image1 + output_image2 + output_concat
        loss= peer_learning_loss(output1, output2,targets, output_image1, output_image2)
